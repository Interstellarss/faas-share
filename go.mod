...
require (
	...
	//github.com/openfaas/faas-netes v0.0.0-20220506172250-0c507aaf8aa5
	//github.com/openfaas/faas-netes v0.0.0-20220503154537-b65231e60d27
...
replace k8s.io/kubernetes => k8s.io/kubernetes v1.24.2
