...
var sharepodsResource = schema.GroupVersionResource{Group: "kubeshare", Version: "v1", Resource: "sharepods"}

var sharepodsKind = schema.GroupVersionKind{Group: "kubeshare", Version: "v1", Kind: "SharePod"}

// Get takes name of the sharePod, and returns the corresponding sharePod object, and an error if there is any.
func (c *FakeSharePods) Get(ctx context.Context, name string, options v1.GetOptions) (result *kubesharev1.SharePod, err error) {
	obj, err := c.Fake.
...
func (c *FakeSharePods) List(ctx context.Context, opts v1.ListOptions) (result *kubesharev1.SharePodList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSharePods) Create(ctx context.Context, sharePod *kubesharev1.SharePod, opts v1.CreateOptions) (result *kubesharev1.SharePod, err error) {
	obj, err := c.Fake.
...
func (c *FakeSharePods) Update(ctx context.Context, sharePod *kubesharev1.SharePod, opts v1.UpdateOptions) (result *kubesharev1.SharePod, err error) {
	obj, err := c.Fake.
...
func (c *FakeSharePods) UpdateStatus(ctx context.Context, sharePod *kubesharev1.SharePod, opts v1.UpdateOptions) (*kubesharev1.SharePod, error) {
	obj, err := c.Fake.
...
func (c *FakeSharePods) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(sharepodsResource, c.ns, name, opts), &kubesharev1.SharePod{})
...
func (c *FakeSharePods) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *kubesharev1.SharePod, err error) {
	obj, err := c.Fake.
